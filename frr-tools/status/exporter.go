...
func main() {
	...
	flag.StringVar(&podName, "pod-name", "", "The namespace this daemon is deployed in")
	...
	if err = (&controller.BGPSessionStateReconciler{
		...
		BFDPeersFetcher: func() (map[string][]frr.BFDPeer, error) { return vtysh.GetBFDPeers(vtysh.Run) },
		NodeName:        nodeName,
		Namespace:       namespace,
		DaemonPod:       daemonPod,
		ResyncPeriod:    2 * time.Minute, // TODO: make configurable
